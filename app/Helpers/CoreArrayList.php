...
function permissionArrayForStaff()
{
    $arr = [
        'dashboard',
        'category',
...
if (!function_exists("getMessage")) {
    ...
    {
        $output = [
            MSG_CREATED_SUCCESSFULLY => __("Created Successfully"),
            MSG_UPDATED_SUCCESSFULLY => __("Updated Successfully"),
            MSG_DELETED_SUCCESSFULLY => __("Deleted Successfully"),
            MSG_UPLOADED_SUCCESSFULLY => __("Uploaded Successfully"),
            MSG_DATA_FETCH_SUCCESSFULLY => __("Data Fetch Successfully"),
            MSG_SOMETHING_WENT_WRONG => __("Something went wrong! Please try again"),
        ];
