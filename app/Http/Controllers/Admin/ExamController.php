...
class ExamController extends Controller
{
    ...
    public function getStudent(Request $request)
    {
        ...
        return view('admin.exam.student-dropdown', $data)->render();
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.exam.edit', $data)->render();
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.exam.view', $data)->render();
    }
    ...
    public function markAssign(Request $request, $id)
    {
        ...
        return view('admin.exam.mark-assign', $data);
    }
    ...
    public function markAssignEdit($id)
    {
        ...
        return view('admin.exam.mark-assign-model', $data)->render();
    }
