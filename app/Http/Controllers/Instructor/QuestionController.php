...
class QuestionController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('Instructor.question.question-list', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Instructor.question.question-edit', $data)->render();
    }
    ...
    public function view($id)
    {
        ...
        return view('Instructor.question.question-view', $data)->render();
    }
