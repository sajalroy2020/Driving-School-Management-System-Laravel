...
class GalleryCategoryService
{
    ...
    {
        $getData = GalleryCategory::where('tenant_id', auth()->user()->tenant_id);

        return datatables($getData)
            ->addIndexColumn()
            ->addColumn('name', function ($getData) {
                return "<p>$getData->category_name</p>";
            })
            ...
            ->addColumn('action', function ($data) {
                return '<div class="dropdown dropdown-one">
                            ...
                            <ul class="dropdown-menu dropdownItem-one">
                                <li>
                                    <button onclick="editCommonModal(\'' . route('admin.setting.frontend-setting.gallery-category.edit', encrypt($data->id)) . '\'' . ', \'#editModal\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8" data-bs-toggle="modal">
                                        <div class="d-flex">
                                ...
                                <li>
                                    <button onclick="deleteCommonMethod(\'' . route('admin.setting.frontend-setting.gallery-category.delete', encrypt($data->id)) . '\', \'galleryCategoryDataTable\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8">
                                        <div class="d-flex">
