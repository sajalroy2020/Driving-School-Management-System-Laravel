...
class AwardService
{
    ...
    {
        $getData = Award::where('tenant_id', auth()->user()->tenant_id);
            ...
            ->addColumn('action', function ($data) {
                return '<div class="dropdown dropdown-one">
                                ...
                                <ul class="dropdown-menu dropdownItem-one">
                                    <li>
                                        <button onclick="editCommonModal(\'' . route('admin.award.edit', encrypt($data->id)) . '\'' . ', \'#edit-modal\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8" data-bs-toggle="modal" data-bs-target="#edit-modal">
                                            <div class="d-flex">
                                    ...
                                    <li>
                                        <button onclick="deleteCommonMethod(\'' . route('admin.award.delete', encrypt($data->id)) . '\', \'awardDataTable\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8">
                                            <div class="d-flex">
    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $uploaded = $new_file->upload('award', $request->image);
                $award->image = $uploaded->id;
            }
