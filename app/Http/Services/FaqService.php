...
class FaqService
{
    ...
    {
        $getData = Faq::where('tenant_id', auth()->user()->tenant_id);
            ...
            ->addColumn('action', function ($data) {
                return '<div class="dropdown dropdown-one">
                            ...
                            <ul class="dropdown-menu dropdownItem-one">
                                <li>
                                    <button onclick="editCommonModal(\'' . route('admin.setting.frontend-setting.faq.edit', encrypt($data->id)) . '\'' . ', \'#editModal\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8" data-bs-toggle="modal">
                                        <div class="d-flex">
                                ...
                                <li>
                                    <button onclick="deleteCommonMethod(\'' . route('admin.setting.frontend-setting.faq.delete', encrypt($data->id)) . '\', \'faqDataTable\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8">
                                        <div class="d-flex">
