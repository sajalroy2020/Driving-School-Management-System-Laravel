...
return new class extends Migration
{
    ...
    {
        Schema::create('certificate_assigns', function (Blueprint $table) {
            $table->id();
            $table->string('certificate_number')->nullable();
            $table->integer('certificate_num_type')->default(ACTIVE);
            $table->bigInteger('student_id')->nullable();
            $table->integer('signature_1_show')->default(ACTIVE);
            $table->integer('signature_2_show')->default(ACTIVE);
            ...
            $table->string('certificate_body')->nullable();
            ...
            $table->string('signature_title_1')->nullable();
            ...
            $table->string('signature_title_2')->nullable();
    ...
    {
        Schema::dropIfExists('certificate_assigns');
    }
};
