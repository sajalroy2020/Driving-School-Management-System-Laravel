  ...
  var Medi = {
    ...
    Basic: {
      ...
      PriceToggle: function () {
        $(document).ready(function () {
          $("#billingMonthly-tab").click(function () {
            $(".priceAmount-monthly").removeClass("d-none");
            $(".priceAmount-monthly").addClass("d-block");
            $(".priceAmount-yearly").removeClass("d-block");
            $(".priceAmount-yearly").addClass("d-none");
          });

          $("#billingYearly-tab").click(function () {
            $(".priceAmount-monthly").removeClass("d-block");
            $(".priceAmount-monthly").addClass("d-none");
            $(".priceAmount-yearly").removeClass("d-none");
            $(".priceAmount-yearly").addClass("d-block");
          });
        });
      },
      ...
      SelectAllCheckbox: function () {
        $("#selectAllProvider").click(function () {
          $("input[type=checkbox]").prop("checked", $(this).prop("checked"));
        });

        $(".allSelect li input[type=checkbox]").click(function () {
          if (!$(this).prop("checked")) {
            $("#selectAllProvider").prop("checked", false);
          }
        });
      },
    },
