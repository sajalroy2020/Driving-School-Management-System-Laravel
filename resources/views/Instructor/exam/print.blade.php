                        ...
                        <div class="pt-20">
                            @if (isset($question))
                                @foreach ($question as $key => $data)
                                    ...
                                    <div class="pt-20">
                                        <p class="d-flex justify-content-between"><strong>{{$key+1}}. {{$data->question_title}}</strong> <span class="fs-15">{{__('Qustion simple text')}} - {{__('Mark')}} ({{$data->question_mark}})</span></p>
                                    ...
                                    <div class="pt-20">
                                        <p class="d-flex justify-content-between"><strong>{{$key+1}}. {{$data->question_title}}</strong> <span class="fs-15">{{__('Qustion Select One')}} - {{__('Mark')}} ({{$data->question_mark}})</span></p>
                                    ...
                                    <div class="pt-20">
                                        <p class="d-flex justify-content-between"><strong>{{$key+1}}. {{$data->question_title}}</strong> <span class="fs-15">{{__('Qustion Select Many')}} - {{__('Mark')}} ({{$data->question_mark}})</span></p>
                                        @foreach ($data->questionsOption as $items)
                                            <div class="d-flex align-items-center pt-6 pl-20">
