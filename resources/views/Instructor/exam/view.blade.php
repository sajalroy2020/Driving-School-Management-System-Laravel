            ...
            <div class="col-12">
                <div class="bd-ra-15 bg-white p-sm-30 p-15 mb-30">
                    <div class="table-wrapTop d-flex align-items-center justify-content-center justify-content-md-between flex-wrap g-10 pb-18">
                        ...
                        <div class="">
                            <a href="{{ route('instructor.exam.print', encrypt($exam->id)) }}" class="py-13 pr-15 pl-10 bd-one bd-c-primary-color bg-primary-color bd-ra-4 fs-14 fw-500 lh-14 text-white d-flex align-items-center"> <i class="fa-solid fa-print mr-10"></i> {{__('Print')}}</a>
                        </div>
                    </div>
