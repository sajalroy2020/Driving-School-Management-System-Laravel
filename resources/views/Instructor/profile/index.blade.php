        ...
        <div class="p-sm-30 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            ...
            <div class="tab-content pt-20">
                <div class="tab-pane fade active show bg-secondary rounded-4" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                    <form class="ajax-request" action="{{route('instructor.profile.update')}}" method="POST" enctype="multipart/form-data" data-handler="commonResponse">
                        @csrf
                ...
                <div class="tab-pane fade bg-secondary rounded-4" id="password-tab-pane" role="tabpanel" aria-labelledby="password-tab" tabindex="1">
                    <form class="ajax-request" action="{{route('instructor.profile.password-update')}}" method="POST" data-handler="passwordChangeResponse">
                        @csrf
                        <div class="row p-30">
                            ...
                            <div class="col-md-6">
                                <div class="pb-30 passShowHide">
                                    ...
                                    <input type="password" class="form-control sf-form-control newPassShowHideInput @error('password') is-invalid @enderror" id="inputNewPassword" placeholder="{{__("Enter your password")}}"  name="password"/>
...
@push('script')
    <script src="{{asset('assets/custom/instructor/js/profile.js')}}"></script>
@endpush
