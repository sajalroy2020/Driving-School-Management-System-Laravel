    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        <div class="p-sm-30 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            ...
            <div class="tab-pane fade show active" id="pills-ClientInformation" role="tabpanel"
                ...
                <form class="ajax-request" action="{{route('admin.student.store')}}" method="POST"
                      enctype="multipart/form-data" data-handler="studentEditResponse">
                    @csrf
                    ...
                    <div class="p-sm-25 p-15  bd-ra-10">
                        ...
                        <div>
                            ...
                            <div class="row rg-20">
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        <label for="asEmailAddress" class="sf-form-label">{{__('Email Address')}} <span
                                                class="text-danger">*</span></label>
                                        <input value="{{$student->email}}" type="email" name="email"
                                               class="form-control sf-form-control sf-form-control-2"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        <label for="asWhatsAppNumber" class="sf-form-label">{{__('Phone Number')}} <span
                                                class="text-danger">*</span></label>
                                        <input value="{{$student->phone}}" type="number" name="number"
                                               class="form-control sf-form-control sf-form-control-2"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        <label for="asZipCode" class="sf-form-label">{{__('Date of Birth')}}
                                            (M-D-Y)<span class="text-danger">*</span></label>
                                        <input value="{{date('Y-m-d', strtotime($student->dob))}}" type="date"
                                               name="date_of_birth"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <select class="sf-select-without-search" name="gender">
                                            ...
                                            <option
                                                {{$student->gender == GENDER_MALE ? 'selected' : ''}} value="{{GENDER_MALE}}">{{__('Male')}}</option>
                                            <option
                                                {{$student->gender == GENDER_FEMALE ? 'selected' : ''}} value="{{GENDER_FEMALE}}">{{__('Female')}}</option>
                                            <option
                                                {{$student->gender == GENDER_OTHERS ? 'selected' : ''}} value="{{GENDER_OTHERS}}">{{__('Others')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        <label for="asCountry" class="sf-form-label">{{__('Country')}} <span
                                                class="text-danger">*</span></label>
                                        <input value="{{$student->country}}" type="text" name="country"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$student->state}}" type="text" name="state"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$student->zip}}" type="text" name="zip_code"
                                               class="form-control sf-form-control sf-form-control-2" id="asZipCode"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <textarea name="address" class="form-control sf-form-control sf-form-control-2"
                                                  placeholder="{{__("Enter Your Address")}}">{{$student->address}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row rg-20">
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$studentContact->contact_person??''}}" type="text"
                                               name="contact_name"
                                               class="form-control sf-form-control sf-form-control-2"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$studentContact->contact_address??''}}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$studentContact->contact_relation??''}}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <input value="{{$studentContact->contact_phone??''}}" type="text"
                                               name="contact_phone"
                                               class="form-control sf-form-control sf-form-control-2"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="fs-18 fw-700 lh-24 text-main-color pt-30">{{__('Student Document')}} :</h4>
                                <button type="button"
                            ...
                            @if(count($studentDocument)  > 0)
                                @foreach ($studentDocument as $key => $document)
                                    ...
                                    <div class="col-md-6">
                                        <div class="zForm-wrap">
                                            ...
                                            <input type="text" name="document_type[]"
                                                   class="form-control sf-form-control sf-form-control-2"
                                                   id="asDocumentsName" placeholder="{{__("Enter Document Type")}}"/>
                                        </div>
                                        <div class="docuemnt_type"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="zForm-wrap">
                                            ...
                                            <input type="text" name="document_name[]"
                                                   class="form-control sf-form-control sf-form-control-2"
                                                   id="asDocumentsName" placeholder="{{__("Enter Document Name")}}"/>
                                        </div>
                                        <div class="docuemnt_name"></div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center cg-10 pt-25">
                        ...
                        <a href="{{url()->previous()}}"
                           class="border-0 bd-ra-12 py-13 px-25 bg-cancel fs-16 fw-600 lh-19 text-main-color">{{__('Cancel Now')}}</a>
                    </div>
                </form>
            </div>
        </div>
