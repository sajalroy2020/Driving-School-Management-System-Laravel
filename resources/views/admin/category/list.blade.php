...
@section('content')
            ...
            <div class="col-12">
                <div class="bd-ra-15 bg-white p-sm-30 p-15 mb-30">
                    <div class="table-wrapTop d-flex align-items-center justify-content-center justify-content-md-between flex-wrap g-10 pb-18">
                        ...
                        <button class="py-13 pr-15 pl-10 bd-one bd-c-primary-color bg-primary-color bd-ra-4 fs-14 fw-500 lh-14 text-white" data-bs-toggle="modal" data-bs-target="#addCategoryModal">+ {{__('Add Category')}}</button>
                    </div>
                    <table class="table zTable zTable-last-item-right" id="categoryDataTable">
                        <thead>
                        <tr>
                            <th>
    ...
    {{-- Add category model --}}
    <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addRoleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 bd-ra-4 p-20">
          ...
          <div class="d-flex justify-content-between align-items-center bd-b-one bd-c-stroke pb-20 mb-20">
            <h4 class="fs-18 fw-600 lh-18 text-main-color">{{__('Add Category')}}</h4>
          ...
          @csrf
            <div class="row rg-20 pb-25">
              <div class="col-12">
                ...
                <input type="text" name="category_name" class="form-control sf-form-control" id="addRoleName" placeholder="Enter Category Name" />
              </div>
              <div class="col-12">
    ...
    <input type="hidden" id="category-list-route" value="{{route('admin.category.list')}}">
@endsection
@push('script')
    <script src="{{asset('assets/custom/admin/js/category.js')}}"></script>
@endpush
