...
@section('content')
            ...
            <div class="col-xl-3 col-md-4">
                <div class="p-sm-25 p-15 bg-white bd-one bd-c-stroke bd-ra-10">
                    ...
                    <ul class="zList-pb-17">
                        <li>
                            ...
                            <div class="multiImages-third">
                                <img class="border-1 h-auto w-auto max-w-150 border-black rounded-5"
                                     src="{{getFileLink($staff->picture)}}" alt="{{__("Profile Picture")}}"/>
                            </div>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Role")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">
                                @if($staff->role == USER_ROLE_STUDENT)
                                    {{__("Student")}}
                                @elseif($staff->role == USER_ROLE_INSTRUCTOR)
                                    {{__("Instructor")}}
                                @elseif($staff->role == USER_ROLE_STAFF)
                                    {{__("Staff")}}
                                @elseif($staff->role == USER_ROLE_ADMIN)
                                    {{__("Admin")}}
                                @else
                                    {{"N/A"}}
                                @endif
                        ...
                        <li>
                            ...
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->name}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Email")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->email}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Phone")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->phone}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Gender")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">
                                @if($staff->gender == GENDER_MALE)
                                    {{__("Male")}}
                                @elseif($staff->gender == GENDER_FEMALE)
                                    {{__("Female")}}
                                @else
                                    {{__("Others")}}
                                @endif
                        ...
                        <li>
                            ...
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->dob}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Address")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->address}}</p>
                        </li>
                    </ul>
                </div>
                <div class="p-sm-25 p-15 bg-white bd-one bd-c-stroke bd-ra-10 mt-20">
                    ...
                    <ul class="zList-pb-17">
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Name:")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->contactList !=null?$staff->contactList->contact_person:'N/A'}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Phone:")}}:</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->contactList !=null?$staff->contactList->contact_phone:'N/A'}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Relation:")}}
                                :</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->contactList !=null?$staff->contactList->contact_relation:'N/A'}}</p>
                        </li>
                        <li>
                            <h4 class="fs-14 fw-400 lh-17 text-main-color pb-7">{{__("Address:")}}
                                :</h4>
                            <p class="fs-12 fw-400 lh-15 text-para-text">{{$staff->contactList !=null?$staff->contactList->contact_address:'N/A'}}</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <input type="hidden" id="user-id" value="{{encrypt($staff->id)}}">
@endsection
@push('script')
