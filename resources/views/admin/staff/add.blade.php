    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        <div class="p-sm-30 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            ...
            <div class="tab-pane fade show active" id="pills-ClientInformation" role="tabpanel"
                ...
                <form class="ajax-request reset" action="{{route('admin.staff.store')}}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <textarea name="address" class="form-control sf-form-control sf-form-control-2"
                                                  id="asDescription"  placeholder="{{__("Enter Your Address")}}"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row rg-20">
                                ...
                                <div class="col-md-6">
                                    <div class="zForm-wrap">
                                        ...
                                        <textarea name="contact_address" class="form-control sf-form-control sf-form-control-2"
                                                  id="contact_address"  placeholder="{{__("Enter Your Contact Address")}}"></textarea>
                                    </div>
                                </div>
                            </div>
