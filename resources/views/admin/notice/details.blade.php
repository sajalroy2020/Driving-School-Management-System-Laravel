...
<div class="row rg-20 mx-0">
    <div class="w-100 bg-secondary px-20 pt-20 pb-8 rounded-1">
        ...
        <div class="zForm-wrap pb-10">
            <h4 class="fs-15 fw-600">{{__("Description")}}: </h4>
            <p class="p-5">{!! $notice->notice_description !!}</p>
        </div>
    </div>
    <p class="text-end text-green-2 fs-14">{{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s',
