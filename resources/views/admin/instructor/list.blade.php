...
@section('content')
                    ...
                    <div class="table-wrapTop d-flex align-items-center justify-content-center justify-content-md-between flex-wrap g-10 pb-18">
                        <div class="d-flex justify-content-center justify-content-sm-start g-10 flex-wrap">
                            <div class="search-one flex-grow-1 max-w-207">
                              ...
                              <input type="text" placeholder="Search here..." id="instructorListTableSearch" />
                            </div>
                        </div>
                        <a href="{{route('admin.instructor.add')}}" class="py-13 pr-15 pl-10 bd-one bd-c-primary-color bg-primary-color bd-ra-4 fs-14 fw-500 lh-14 text-white">+ {{__('Add Instructor')}}</a>
                      </div>
                    <table class="table zTable zTable-last-item-right" id="instructorDataTable">
                        <thead>
                        <tr>
                            <th>
    ...
    <input type="hidden" id="instructor-list-route" value="{{route('admin.instructor.list')}}">
@endsection
@push('script')
